import { PlatformPlugin, PluginType, ErrorType, SegmentError } from '@segment/analytics-react-native';
...
export class DeviceTokenPlugin extends PlatformPlugin {
  ...
  async configure(analytics) {
    ...
    try {
      ...
      this.analytics?.reportInternalError(new SegmentError(ErrorType.PluginError, 'Unable to confirm authorization status', error));
    }
  }
